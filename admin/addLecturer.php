...
<div class="as-wrapper">
	...
	<div class="as-main_content">
		...
		<!-- Content section -->
		<form action="addLecturer.php" method="post" class="as-container" >
			<div class="as-header">Add New Lecturer</div>
				<div class="as-content">
					<h3>Lecture ID</h3>
					<input class="inp" type="text" name="idGuru" required="">
					<h3>Lecture Name</h3>
					<input class="inp" type="text" name="nama" required="">
					<h3>Phone Number</h3>
					<input class="inp" type="text" name="notelefon" required="">
					<h3>Address</h3>
					<textarea class="inp" rows="10" cols="30" name="alamat" required=""></textarea>
					<h3>Password</h3>
					<input class="inp" type="password" name="password_1" required="">
					<h3>Confirm Password</h3>
					<input class="inp" type="password" name="password_2" required="">
				</div>
				<div class="as-content-sm">
					...
					<button class="btn-outline" style="position: relative;" type="submit" name="teachers_btn">Submit</button>
				</div>
		</form> 
		<!-- Footer section -->
